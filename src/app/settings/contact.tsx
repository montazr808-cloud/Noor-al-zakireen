...
import { ImageBackground, Linking, SafeAreaView, ScrollView, StyleSheet, Text, TouchableOpacity, View } from 'react-native';
      ...
      <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={styles.scroll}>
        ...
        <View style={[styles.glassCard, { marginTop: 20 }]}>
          <TouchableOpacity
            ...
            onPress={() => open('https://www.instagram.com/noor_alzakireen')}
            activeOpacity={0.75}
          >
            ...
            <View style={styles.rowContent}>
              <Text style={styles.rowTitle}>إنستغرام</Text>
              <Text style={styles.rowDesc}>@noor_alzakireen</Text>
            </View>
          ...
          <TouchableOpacity
            style={styles.row}
            onPress={() => open('https://t.me/noor_alzakireen')}
            activeOpacity={0.75}
          >
            ...
            <View style={styles.rowContent}>
              <Text style={styles.rowTitle}>تيليغرام</Text>
              <Text style={styles.rowDesc}>@noor_alzakireen</Text>
            </View>
            <Ionicons name="chevron-back" size={16} color={C.muted} />
          </TouchableOpacity>
